...
class ECPStudent
{
	...
	public function saveUserProducts($ecp_products)
	{
		...
		fb($previous_orders_details = get_user_meta($this -> _id, "_IDGL_elem_ECP_user_orders_details", true));
		fb($orders_details = (empty($previous_orders_details)) ? array() : $previous_orders_details);
	...
	private function _sendMail()
	{
		 ...
		 //fb(wp_mail($this -> _username, $this -> _msg_subject, $this->_msg_body, $headers));
