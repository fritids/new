					...
					foreach($questions as $k=>$question) {
						...
						if($question->type == "Multiple Choice") {
							foreach($options as $k=>$option)
								if($option['correct']) {
									$html .= '<td width="25" align="center" class="row-desc">'.$letter_array[$k].'</td>';
									break;
								}
						} else {
							...
							if($options[0]['type'] == "Range") {
								$html .= '<td width="25" align="center" class="row-desc">'.$options[0]['start'].'&#62;x&#60;'.$options[0]['end'].'</td>';
							} else {
								$html .= '<td width="25" align="center" class="row-desc">'.$options[0]['field_1'].$options[0]['field_2'].$options[0]['field_3'].$options[0]['field_4'].'</td>';
							}
						}
					}
					...
					foreach($questions as $k=>$question) {
						...
						if($question->type == "Multiple Choice") {
							...
							if($options[$answer]['correct'])
								$html .= '<td width="25" align="center" class="row-desc"><img src="../../images/right.png" border="0" height="10" width="10" /></td>';
							elseif($letter_array[$answer])
								$html .= '<td width="25" align="center" class="row-desc wrong">'.$letter_array[$answer].'</td>';
							else
								$html .= '<td width="25" align="center" class="row-desc wrong">-</td>';
						} else {
							$answer = $answers[$question->id];
							$number = to_number($answer['field_1_value'].$answer['field_2_value'].$answer['field_3_value'].$answer['field_4_value']);
							...
							if(!$correct) {
								$html .= '<td width="25" align="center" class="row-desc wrong">'.$answer['field_1_value'].$answer['field_2_value'].$answer['field_3_value'].$answer['field_4_value'].'</td>';
							}
						}
