    ...
    function admin_notice($notice = 'default-error', $fadetime = 0) {
        ...
        switch ($notice){
            ...
            case 'configuration-warning':
                $notice_text = "Please go to the <a href='".HUBSPOT_ADMIN."/admin.php?page=hubspot_settings'>HubSpot settings page</a> and insert your Hub ID, Application Domain and Feedburner feed to begin collecting website statistics or to hide this warning.
                                    <br /><br />
