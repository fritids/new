	...
	*/
	...
	function ShowTab2(T2)
	{
		...
		document.getElementById("paging" +  T2).style.display = "";
		document.getElementById("div" + T2).style.display = "";
		document.getElementById("tab" + T2).className = "active";
	}