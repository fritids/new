...
class ECPUser{
	public static function getUserMenu(){
		if(!is_user_logged_in()){
			 echo 'Welcome Guest | ';
		     echo '<a href="'.get_bloginfo("url").'/login/">login</a>'; 
		}else{
			 global $current_user;
		     get_currentuserinfo();
		     echo '<a href="'.get_bloginfo("url").'/profile">Welcome ' . $current_user->user_login . " | ";
		     echo 'profile</a> | '; 
		     echo '<a href="'.get_bloginfo("url").'/logout">logout</a>'; 
