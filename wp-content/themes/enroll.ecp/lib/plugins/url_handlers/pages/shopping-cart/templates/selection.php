...
<form action="account" method="POST" id="ecp_cart_form">
	<div class="whitebox">
		...
		<div class="invisible">
			<input type="hidden" id="ecp_essays_quantity" name="ecp_essays_quantity" value='<?php echo ($ecp_cart -> getProductsQuantity()) ? json_encode($ecp_cart -> getProductsQuantity()) : ""; ?>' />
		</div>
