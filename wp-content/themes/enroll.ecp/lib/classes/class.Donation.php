...
class Donation
{
	const API_KEY = 'q23343aikzh5'; //q23343aikzh5    DONORSCHOOSE
	const API_PASS = 'w94i85nbjmr58cu97nt8'; //w94i85nbjmr58cu97nt8    helpClassrooms!
	const ACTION = 'donate';

	private $_search_url = 'http://api.donorschoose.org/common/json_feed.html';
	private $_search_test_url = 'http://api.donorschoose.org/common/json_feed.html';
	private $_donation_url = 'https://apisecure.donorschoose.org/common/json_api.html';
	private $_donation_test_url = 'https://apisecure.donorschoose.org/common/json_api.html';
	private $_parameters;
	private $_connection;
	...
	{
		$this -> _donation_amount = $amount;
		return $this -> _get_donation_project();
		//return $this -> _check_ammount_to_donate($amount, $project_data);
	}
	...
	private function _get_donation_project()
	{
		...
		$costToComplete=( isset($_POST['costToComplete']) ? $_POST['costToComplete'] : '1');
		$sortBy=( isset($_POST['sortBy']) ? $_POST['sortBy'] : '0');
		$proposalType=( isset($_POST['proposalType']) ? $_POST['proposalType'] : '1');
	 ...
	 * @param float $amount
	 */
	public function _send_donation($amount, $project_id)
	{
		// donate
