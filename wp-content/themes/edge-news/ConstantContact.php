<?php
    ...
    */
    class CC_Utility {
        ...
        var $login = 'jessbrondo'; //Username for your account
        var $password = 'Stella18'; //Password for your account
        var $apikey = '7cdd0bae-371d-4603-85f4-90be4757a7c7'; // API Key for your account.
