...
<div class="whitebox profile">
    ...
    <div class="split right">
        ...
        <div class="bluebox">
            ...
            <label><span>Old Password:</span> <input name="" type="password" value="" /></label>
            <label><span>New Password:</span> <input name="" type="password" value="" /></label>
            <label><span>Repeat New Password:</span> <input name="" type="password" value="" /></label>
        </div>
