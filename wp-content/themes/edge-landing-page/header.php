...
<!-- Modal Script -->		
	...
	$(document).ready(function(){
		...
		$('a#pointer3').click(function(e){
			modal.open({content: "<h3>Unparalleled materials/teaching methods; Only REAL exams used.</h3>Over the past 7 years, Edge students have improved an average of 100 points for every 10<br> hours of prep the complete with us. How do we do it? Through our SAT/ACT Edge program.<br> All Edge students use a combination of The SAT/ACT Edge Guide, Online Course, and iPhone app.<br> Our instructors also have an uncanny combination of charisma and brilliance and motivation<br> students through their teacher methods. All instructors, who have graduated from top US<br> universities and have scored in at least the 98th percentile on their standardized tests, are<br> personally trained by The Edge's founder during an extensive interview, training, & testing program.<br><br><a href=\"http://info.edgeincollegeprep.com/take-your-first-step-towards-acceptance-at-your-dream-school/\"><div class=\"c2a\">Get Started Today!</div></a>"});
			e.preventDefault();
		});
		$('a#admission1').click(function(e){
			modal.open({content: "<h3>Advisory Services</h3>Your own personal private guidance counselor there to assist you with ALL<br> of the tough decisions in high school, including courseloa, summer programs,<br> meaningful community service projects, leadership experience, the creation<br> of a school list, and even the more dramatic issues like expulsion and suspension.<br><br><a href=\"http://info.edgeincollegeprep.com/schedule-your-free-30-minute-consultation-today/\"><div class=\"c2a\">Get Started Today!</div></a>"});
			e.preventDefault();
		});
		$('a#admission2').click(function(e){
			modal.open({content: "<h3>Application Packages</h3>Assistance with every aspect of you college application, including the creation of an application<br> timeline, the entry of student/family data, the brainstorming/outlining/perfecting ALL of your<br> essays, development of the ideal resume/CV, selection of ideal references, and the honing ideal<br> interviewing skills.<br><br><a href=\"http://info.edgeincollegeprep.com/schedule-your-free-30-minute-consultation-today/\"><div class=\"c2a\">Get Started Today!</div></a>"});
			e.preventDefault();
		});
		$('a#admission3').click(function(e){
			modal.open({content: "<h3>Special Cases</h3>Special cases are our specialty. Whether you are an NCAA recruited athletes or<br> an elite musician looking to apply to the top seminaries, The Edge has the<br> perfect advisor to assist you with all of the intricate components of the application<br> process. With international team members in London, Frankfurt, Buenos Aires,<br> and Rio de Janeiro, we have become experts at working with international students<br> and have assisted students from over 13 countries. Our Global Elite team can help<br> you with everything from in-person, Skype, or travel tutoring, admissions counseling, <br>and every aspect of the application process.<br><br><a href=\"http://info.edgeincollegeprep.com/schedule-your-free-30-minute-consultation-today/\"><div class=\"c2a\">Get Started Today!</div></a>"});
			e.preventDefault();
		});
