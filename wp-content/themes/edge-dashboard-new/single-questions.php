...
?>
<?php edit_post_link('Edit Question', '<p>', '</p>'); ?>
<?php if(!$is_review){?>
        ...
        <div class="leftcolumn widecolumn">
            ...
            <div class="greybox">
            	...
            	?>
	            	...
	            	<h3><?php echo apply_filters('the_content', $qcontent); ?></h3>
	            	<!-- Question passgae begin -->
		            	...
		            	<ul class="test_qs">
		                    <?php 
		                    	echo "<li val='a'><span>A</span>".apply_filters('the_content',$answer["a"]["value"])."</li>";
		                    	echo "<li val='b'><span>B</span>".apply_filters('the_content',$answer["b"]["value"])."</li>";
		                    	echo "<li val='c'><span>C</span>".apply_filters('the_content',$answer["c"]["value"])."</li>";
		                    	echo "<li val='d'><span>D</span>".apply_filters('the_content',$answer["d"]["value"])."</li>";
		                    	echo "<li val='e'><span>E</span>".apply_filters('the_content',$answer["e"]["value"])."</li>";
		                    ?>
		                </ul>
            	...
            	?>
	            	<div class='qpanel' id='qpanel_<?php echo $quid; ?>' style="display:none;">
		            	...
		            	<ul class="test_qs">
		                    <?php 
		                    	...
		                    	$correct=$data["answers"][$question_id[$i]]==$options["answer"]["correct"];
		                ...
		                <?php }elseif($answer_type=="answer_dropdown"){
		                	//echo $data["answers"][$question_id[$i]];
		                	if($data["answers"][$question_id[$i]]==""){
		                		echo "<h3 class='blue'>Your answer is <span class='purple'>missing</span></h3>";
		                	}else if($data["answers"][$question_id[$i]]==$answer["dropdown"]){
								echo "<h3 class='blue'>Your answer <span class='answerblock green'>".($answer["dropdown"])."</span> is <span class='green'>correct</span></h3>";
							}else{
								echo "<h3 class='blue'>Your answer <span class='answerblock red'>".($answer["dropdown"])."</span> is <span class='red'>incorrect</span></h3>";
							}
		                }?>
		            ...
		            <?php if(!$correct):?>
	               	<div class="correct_summary">
	               		<h3 class="blue">The Correct Answer is:</h3>
		            	<ul class="test_qs">
		            		<?php
