		...
		<table cellpadding='0' cellspacing='0' border='8' id='numbered' style='display:none;'>
			<tr>
				...
				<td class='numbered_passage'>
					<textarea id='passage_content' wrap='off' name='IDGL_elem".$pagename."[".$name."][numbered_passage]' style='width:750px; min-height:200px;'>".$current['numbered_passage']."</textarea>
				</td>
			</tr>
		</table>
...
function ecp_answer_callback($param,$name,$pagename=""){
	...
	//print_r($current);
	//Array ( [answer_type] => answer_plain [answer] => Array ( [a] => Array ( [value] => (-h, -k) ) [b] => Array ( [value] => (-h, k) ) [c] => Array ( [value] => (2h, 2k) ) [d] => Array ( [value] => (h2, k) ) [e] => Array ( [value] => (h, k2) ) [dropdown] => ) )
	...
	if(is_array($current)){
		...
		$answer_range_sel=($current["answer_type"]=="answer_range")? " checked='checked' " : '' ;
	...
	$outStr="<div>
		<div style='margin-bottom:10px;padding-bottom:5px;border-bottom:solid 1px #cacaca;min-width:800px;'>
			...
			<input class='answer_type' type='radio' name='IDGL_elem".$pagename."[".$name."][answer_type]' value='answer_range' $answer_range_sel  /> range of values
		</div>
		...
		<div id='answer_range' style='display:none;'>
			<div style='margin-top:10px;'>Enter the range:</div>
			from: <input style='width:250px;' type='text' name='IDGL_elem".$pagename."[".$name."][answer][range_from]' value='".$current['answer']['range_from']."' />
			to: <input style='width:250px;' type='text' name='IDGL_elem".$pagename."[".$name."][answer][range_to]' value='".$current['answer']['range_to']."' />
		</div>
	</div>
	<script type='text/javascript'>
		jQuery(function(){
