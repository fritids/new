            ...
            <div class="greybox">
            	...
            	?>
	            	...
	            	<!-- Question passgae begin -->
		            	...
		            	<ul class="test_qs">
		                    <?php 
		                    	echo "<li val='a'><span>A</span>".$answer["a"]["img_pre"]." - ".$answer["a"]["value"]."</li>";
...
<div class="leftcolumn widecolumn">
            ...
            <div class="greybox resultsbox">
            	...
            	?>
					...
					//print_r($data["answers"][$question_id[$i]]);
		                	if($data["answers"][$question_id[$i]]==""){
		                		echo "<h3 class='blue'>Your answer is <span class='purple'>missing</span></h3>";
		                	}else if($data["answers"][$question_id[$i]]==$answer["dropdown"]){
								echo "<h3 class='blue'>Your answer <span class='answerblock green'>".($data["answers"][$question_id[$i]])."</span> is <span class='green'>correct</span></h3>";
							}else{
								echo "<h3 class='blue'>Your answer <span class='answerblock red'>".($data["answers"][$question_id[$i]])."</span> is <span class='red'>incorrect</span></h3>";
							}
		                }?>
				...
				<?php //var_dump($options); //var_dump($options["answer"]); //var_dump($answer);?>
		            	<ul class="test_qs">
		            		<?php
						if($answer_type!="answer_dropdown"){
							if(is_array($answer)){            					
							...
							echo "<li val='a'><div class='answermark correct'></div>".$options["answer"]["dropdown"]."</li>";
						}						
		            		?>
		            	</ul>
	               	</div>
