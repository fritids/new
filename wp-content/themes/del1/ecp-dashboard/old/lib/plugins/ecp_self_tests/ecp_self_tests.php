...
function ecp_answer_callback($param,$name,$pagename=""){
	...
	$outStr="<div>
		...
		<div id='answer_plain' style='display:none;'>
				...
				<div style='margin-top:10px;'>Answer Option A</div>
				<textarea class='theEditor' style='width:700px;height:200px;' type='text' name='IDGL_elem".$pagename."[".$name."][answer][a][value]'>".htmlentities($current['answer']['a']['value'],ENT_QUOTES)."</textarea>  | <input type='radio' value='a' name='IDGL_elem".$pagename."[".$name."][answer][correct]' $answer_correct_a_sel /> correct answer
				<hr/>
				
				<div style='margin-top:10px;'>Answer Option B</div>
				<textarea class='theEditor' style='width:700px;height:200px;' type='text' name='IDGL_elem".$pagename."[".$name."][answer][b][value]'>".htmlentities($current['answer']['b']['value'],ENT_QUOTES)."</textarea>  | <input type='radio' value='b' name='IDGL_elem".$pagename."[".$name."][answer][correct]' $answer_correct_a_sel /> correct answer
				<hr/>
				
				<div style='margin-top:10px;'>Answer Option C</div>
				<textarea class='theEditor' style='width:700px;height:200px;' type='text' name='IDGL_elem".$pagename."[".$name."][answer][c][value]'>".htmlentities($current['answer']['c']['value'],ENT_QUOTES)."</textarea>  | <input type='radio' value='c' name='IDGL_elem".$pagename."[".$name."][answer][correct]' $answer_correct_a_sel /> correct answer
				<hr/>
				
				<div style='margin-top:10px;'>Answer Option D</div>
				<textarea class='theEditor' style='width:700px;height:200px;' type='text' name='IDGL_elem".$pagename."[".$name."][answer][d][value]'>".htmlentities($current['answer']['d']['value'],ENT_QUOTES)."</textarea>  | <input type='radio' value='d' name='IDGL_elem".$pagename."[".$name."][answer][correct]' $answer_correct_a_sel /> correct answer
				<hr/>
				
				<div style='margin-top:10px;'>Answer Option E</div>
				<textarea class='theEditor' style='width:700px;height:200px;' type='text' name='IDGL_elem".$pagename."[".$name."][answer][e][value]'>".htmlentities($current['answer']['e']['value'],ENT_QUOTES)."</textarea>  | <input type='radio' value='e' name='IDGL_elem".$pagename."[".$name."][answer][correct]' $answer_correct_a_sel /> correct answer
				<hr/>
...
function ecp_drill_questions_callback($param,$name,$pagename=""){
	...
	$out="<div class='sortables-wrap'>
			<div syle='margin-bottom:10px;'>
				select a category $cat_out
			</div>
			<div style='float:left;width:49%;' id='question_list'></div>
			<div style='float:right;width:50%;' id='selected_question_list'>$postQuestions</div>
