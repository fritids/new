jQuery(document).ready(function(){
	...
	browser = jQuery("#abz_dialog").dialog({ 
						...
						buttons:{
							'Select': function() {
								var val=jQuery("#abz_selected_file").val().replace("/fg0txn14/ecp_questions_explained/streams/_definst_/","").replace(".flv","")
						...
						open: function(event, ui) {
							AjaxCall('action=getFolders&dirName=/fg0txn14/ecp_questions_explained/streams/_definst_');
						}
			  });
