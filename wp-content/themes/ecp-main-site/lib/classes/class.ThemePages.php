...
/**
 * 
 * Class for generating theme options ...
 * @author Igor
 *
 */
...
class IDGL_ThemePages{
	...
	/**
	 * 
	 * Registers menu with pages from model ...
	 * 
	 */
	...
	/**
	 * 
	 * Adds menu in IDGL Settings but parses custom file model , not from standard model folder ...
	 * @param string $file
	 */
	...
	/**
	 * 
	 * Register setting in database for theme page
	 * 
	 */
