...
<input type="text" name="x<?php echo $RowIndex ?>_session_date" id="x<?php echo $RowIndex ?>_session_date" title="" size="10" value="<?php echo $tbl_session->session_date->EditValue ?>"<?php echo $tbl_session->session_date->EditAttributes() ?>>
		...
		<!-- session_number -->
		<td width="100">
<input type="text" name="x<?php echo $RowIndex ?>_session_number" id="x<?php echo $RowIndex ?>_session_number" title="" size="5" value="<?php echo $tbl_session->session_number->EditValue ?>"<?php echo $tbl_session->session_number->EditAttributes() ?>></td>
		<!-- session_goal -->
		<td width="100">
<input type="text" name="x<?php echo $RowIndex ?>_session_goal" id="x<?php echo $RowIndex ?>_session_goal" title="" size="5" maxlength="125" value="<?php echo $tbl_session->session_goal->EditValue ?>"<?php echo $tbl_session->session_goal->EditAttributes() ?>></td>
		<!-- session_goal_completed -->
		<td width="100">
<input type="text" name="x<?php echo $RowIndex ?>_session_goal_completed" id="x<?php echo $RowIndex ?>_session_goal_completed" title="" size="5" maxlength="125" value="<?php echo $tbl_session->session_goal_completed->EditValue ?>"<?php echo $tbl_session->session_goal_completed->EditAttributes() ?>></td>
		<!-- session_homework -->
		<td width="100">
<input type="text" name="x<?php echo $RowIndex ?>_session_homework" id="x<?php echo $RowIndex ?>_session_homework" title="" size="5" maxlength="125" value="<?php echo $tbl_session->session_homework->EditValue ?>"<?php echo $tbl_session->session_homework->EditAttributes() ?>></td>
		<!-- session_hmwrk_completed -->
		<td width="100">
<input type="text" name="x<?php echo $RowIndex ?>_session_hmwrk_completed" id="x<?php echo $RowIndex ?>_session_hmwrk_completed" title="" size="5" maxlength="125" value="<?php echo $tbl_session->session_hmwrk_completed->EditValue ?>"<?php echo $tbl_session->session_hmwrk_completed->EditAttributes() ?>></td>
		<!-- s_stuid -->
	  <td>
...
<?php if ($Security->IsLoggedIn()) { ?>
<td nowrap><span class="edge">
<a href="<?php echo $tbl_session->DeleteUrl() ?>">Delete</a>
</span></td>
<?php } ?>
<?php } ?>
<?php } ?>
