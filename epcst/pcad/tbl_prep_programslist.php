...
if (@$_GET["a"] <> "") {
	...
	if ($tbl_prep_programs->CurrentAction == "add" || $tbl_prep_programs->CurrentAction == "copy") {
		InlineAddMode();
	}
} else {
	...
	if (@$_POST["a_list"] <> "") {
		...
		// Insert Inline
		if ($tbl_prep_programs->CurrentAction == "insert" && @$_SESSION[EW_SESSION_INLINE_MODE] == "add") {
			InlineInsert();
		}
	}
}
...
 
<p><span class="edge" style="white-space: nowrap;">Student's Prep Programs </span></p>
<?php if ($tbl_prep_programs->Export == "") { ?>
<?php } ?>
<?php
...
<?php if ($tbl_prep_programs->Export == "") { ?>
<?php } ?>
<?php if ($nTotalRecs > 0 || $tbl_prep_programs->CurrentAction == "add" || $tbl_prep_programs->CurrentAction == "copy") { ?>
<table border="0" cellspacing="5" cellpadding="5">
<?php
	if ($tbl_prep_programs->CurrentAction == "add" || $tbl_prep_programs->CurrentAction == "copy") {
		$RowIndex = 1;
		if ($tbl_prep_programs->EventCancelled) { // Insert failed
			RestoreFormValues(); // Restore form values
		}

		// Init row class and style
		$tbl_prep_programs->CssClass = "ewTableEditRow"; // edit
		...
		// Render add row
		$tbl_prep_programs->RowType = EW_ROWTYPE_ADD;
		RenderRow();
?>
<?php $ColCnt = 1 ?>
<tr<?php echo $tbl_prep_programs->DisplayAttributes() ?>>
	...
	<table class="ewTable">
		<tr>
			<td class="ewTableHeader">Arithmetic</td>
			<td>
<input type="text" name="x<?php echo $RowIndex ?>_p_arithmetic" id="x<?php echo $RowIndex ?>_p_arithmetic" title="" size="15" maxlength="45" value="<?php echo $tbl_prep_programs->p_arithmetic->EditValue ?>"<?php echo $tbl_prep_programs->p_arithmetic->EditAttributes() ?>></td>
		</tr>
		<tr>
			<td class="ewTableHeader">Algebra</td>
			<td>
<input type="text" name="x<?php echo $RowIndex ?>_p_algebra" id="x<?php echo $RowIndex ?>_p_algebra" title="" size="15" maxlength="45" value="<?php echo $tbl_prep_programs->p_algebra->EditValue ?>"<?php echo $tbl_prep_programs->p_algebra->EditAttributes() ?>></td>
		</tr>
		<tr>
			<td class="ewTableHeader">Techniques</td>
			<td>
<input type="text" name="x<?php echo $RowIndex ?>_p_techniques" id="x<?php echo $RowIndex ?>_p_techniques" title="" size="15" maxlength="45" value="<?php echo $tbl_prep_programs->p_techniques->EditValue ?>"<?php echo $tbl_prep_programs->p_techniques->EditAttributes() ?>></td>
		</tr>
		<tr>
			<td class="ewTableHeader">Geometry</td>
			<td>
<input type="text" name="x<?php echo $RowIndex ?>_p_geometry" id="x<?php echo $RowIndex ?>_p_geometry" title="" size="15" maxlength="45" value="<?php echo $tbl_prep_programs->p_geometry->EditValue ?>"<?php echo $tbl_prep_programs->p_geometry->EditAttributes() ?>></td>
		</tr>
		<tr>
			<td class="ewTableHeader">Advance Topics</td>
			<td>
<input type="text" name="x<?php echo $RowIndex ?>_p_advanced_topics" id="x<?php echo $RowIndex ?>_p_advanced_topics" title="" size="15" maxlength="45" value="<?php echo $tbl_prep_programs->p_advanced_topics->EditValue ?>"<?php echo $tbl_prep_programs->p_advanced_topics->EditAttributes() ?>></td>
		</tr>
		<tr>
			<td class="ewTableHeader">Sentence Completion</td>
			<td>
<input type="text" name="x<?php echo $RowIndex ?>_p_sentence_completion" id="x<?php echo $RowIndex ?>_p_sentence_completion" title="" size="15" maxlength="45" value="<?php echo $tbl_prep_programs->p_sentence_completion->EditValue ?>"<?php echo $tbl_prep_programs->p_sentence_completion->EditAttributes() ?>></td>
		</tr>
		<tr>
			<td class="ewTableHeader">Critical Reading</td>
			<td>
<input type="text" name="x<?php echo $RowIndex ?>_p_critical_reading" id="x<?php echo $RowIndex ?>_p_critical_reading" title="" size="15" maxlength="45" value="<?php echo $tbl_prep_programs->p_critical_reading->EditValue ?>"<?php echo $tbl_prep_programs->p_critical_reading->EditAttributes() ?>></td>
		</tr>
		<tr>
			<td class="ewTableHeader">Error ID</td>
			<td>
<input type="text" name="x<?php echo $RowIndex ?>_p_error_id" id="x<?php echo $RowIndex ?>_p_error_id" title="" size="15" maxlength="45" value="<?php echo $tbl_prep_programs->p_error_id->EditValue ?>"<?php echo $tbl_prep_programs->p_error_id->EditAttributes() ?>></td>
		</tr>
		<tr>
			<td class="ewTableHeader">Sentence Improvement</td>
			<td>
<input type="text" name="x<?php echo $RowIndex ?>_p_sentence_improvement" id="x<?php echo $RowIndex ?>_p_sentence_improvement" title="" size="15" maxlength="45" value="<?php echo $tbl_prep_programs->p_sentence_improvement->EditValue ?>"<?php echo $tbl_prep_programs->p_sentence_improvement->EditAttributes() ?>></td>
		</tr>
		<tr>
			<td class="ewTableHeader">Paragraph Improvement</td>
			<td>
<input type="text" name="x<?php echo $RowIndex ?>_p_paragraph_improvement" id="x<?php echo $RowIndex ?>_p_paragraph_improvement" title="" size="15" maxlength="45" value="<?php echo $tbl_prep_programs->p_paragraph_improvement->EditValue ?>"<?php echo $tbl_prep_programs->p_paragraph_improvement->EditAttributes() ?>></td>
		</tr>
		<tr>
			<td ></td>
			<td>
...
<span class="edge">
<a href="" onClick="if (ew_ValidateForm(document.ftbl_prep_programslist)) document.ftbl_prep_programslist.submit();return false;">Insert</a>&nbsp;<a href="tbl_prep_programslist.php?a=cancel">Cancel</a>
...
<tr>
<?php } ?>
	<td valign="top"<?php echo $tbl_prep_programs->DisplayAttributes() ?>>
	<table class="ewTable">
		<tr class="ewTableRow">
			<td></td>
			<td<?php echo $tbl_prep_programs->p_prepid->CellAttributes() ?>>
...
Arithmetic
<?php } else { ?>
	Arithmetic<?php if ($tbl_prep_programs->p_arithmetic->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_prep_programs->p_arithmetic->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?>
<?php } ?>
			</td>
...
Algebra
<?php } else { ?>
	Algebra<?php if ($tbl_prep_programs->p_algebra->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_prep_programs->p_algebra->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?>
<?php } ?>
			</td>
...
Techniques
<?php } else { ?>
	Techniques<?php if ($tbl_prep_programs->p_techniques->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_prep_programs->p_techniques->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?>
<?php } ?>
			</td>
...
Geometry
<?php } else { ?>
	Geometry<?php if ($tbl_prep_programs->p_geometry->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_prep_programs->p_geometry->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?>
<?php } ?>
			</td>
...
Advance Topics
<?php } else { ?>
	Advance Topics<?php if ($tbl_prep_programs->p_advanced_topics->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_prep_programs->p_advanced_topics->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?>
<?php } ?>
			</td>
...
<?php } ?>
		...
		<tr class="ewTableRow">
			<td></td>
			<td<?php echo $tbl_prep_programs->s_stuid->CellAttributes() ?>>
<?php if ($tbl_prep_programs->RowType == EW_ROWTYPE_EDIT) { // Edit Record ?>
<?php if ($tbl_prep_programs->s_stuid->getSessionValue() <> "") { ?>
<input type="hidden" id="x<?php echo $RowIndex ?>_s_stuid" name="x<?php echo $RowIndex ?>_s_stuid" value="<?php echo ew_HtmlEncode($tbl_prep_programs->s_stuid->CurrentValue) ?>">
<?php } else { ?>
...
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<a href="<?php echo $tbl_prep_programs->DeleteUrl() ?>">Delete</a>&nbsp;
<?php } ?>
<?php } ?>
<?php } ?>
</span>
...
<?php } ?>
<?php } ?>
<?php if ($tbl_prep_programs->CurrentAction == "add" || $tbl_prep_programs->CurrentAction == "copy") { ?>
...
<table>
  <tr>
    <td><span class="edge">
      <?php if ($Security->IsLoggedIn()) { ?>
      <a href="tbl_prep_programslist.php?a=add"> Add</a>&nbsp;&nbsp;
      <?php } ?>
    </span></td>
  </tr>
</table>
...
?>
<?php if ($tbl_prep_programs->Export == "") { ?>
<form action="tbl_prep_programslist.php" name="ewpagerform" id="ewpagerform">
...
<?php if ($Pager->RecordCount > 0) { ?>
	...
	<a href="tbl_prep_programslist.php?start=<?php echo $Pager->FirstButton->Start ?>"><b>First</b></a>&nbsp;
	<?php } ?>
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<a href="tbl_prep_programslist.php?start=<?php echo $Pager->PrevButton->Start ?>"><b>Previous</b></a>&nbsp;
	<?php } ?>
	<?php foreach ($Pager->Items as $PagerItem) { ?>
		<?php if ($PagerItem->Enabled) { ?><a href="tbl_prep_programslist.php?start=<?php echo $PagerItem->Start ?>"><?php } ?><b><?php echo $PagerItem->Text ?></b><?php if ($PagerItem->Enabled) { ?></a><?php } ?>&nbsp;
	<?php } ?>
	<?php if ($Pager->NextButton->Enabled) { ?>
	<a href="tbl_prep_programslist.php?start=<?php echo $Pager->NextButton->Start ?>"><b>Next</b></a>&nbsp;
	<?php } ?>
	<?php if ($Pager->LastButton->Enabled) { ?>
	<a href="tbl_prep_programslist.php?start=<?php echo $Pager->LastButton->Start ?>"><b>Last</b></a>&nbsp;
	<?php } ?>
...
function InlineAddMode() {
	global $Security, $tbl_prep_programs;
	$tbl_prep_programs->CurrentAction = "add";
...
function InlineInsert() {
	...
	$objForm->Index = 1;
	LoadFormValues(); // Get form values
	$tbl_prep_programs->SendEmail = TRUE; // Send email on add success
	if (AddRow()) { // Add record
		...
		$tbl_prep_programs->EventCancelled = TRUE; // Set event cancelled
		$tbl_prep_programs->CurrentAction = "add"; // Stay in add mode
	}
}
...
function RenderRow() {
	...
	if ($tbl_prep_programs->RowType == EW_ROWTYPE_VIEW) { // View row
		...
		$tbl_prep_programs->p_prepid->EditValue = ew_HtmlEncode($tbl_prep_programs->p_prepid->CurrentValue);
		...
		$tbl_prep_programs->s_stuid->EditValue = ew_HtmlEncode($tbl_prep_programs->s_stuid->CurrentValue);
		}
...
function AddRow() {
	...
	$bCheckKey = TRUE;
	$sFilter = $tbl_prep_programs->SqlKeyFilter();
	if (trim(strval($tbl_prep_programs->p_prepid->CurrentValue)) == "") {
		$bCheckKey = FALSE;
	} else {
		$sFilter = str_replace("@p_prepid@", ew_AdjustSql($tbl_prep_programs->p_prepid->CurrentValue), $sFilter); // Replace key value
	}
	...
	if ($bCheckKey) {
		$rsChk = $tbl_prep_programs->LoadRs($sFilter);
		if ($rsChk && !$rsChk->EOF) {
	...
	$bInsertRow = $tbl_prep_programs->Row_Inserting($rsnew);
	if ($bInsertRow) {
		$conn->raiseErrorFn = 'ew_ErrorFn';
		$AddRow = $conn->Execute($tbl_prep_programs->InsertSQL($rsnew));
		$conn->raiseErrorFn = '';
	} else {
		if ($tbl_prep_programs->CancelMessage <> "") {
			$_SESSION[EW_SESSION_MESSAGE] = $tbl_prep_programs->CancelMessage;
	...
	if ($AddRow) {
		$tbl_prep_programs->p_prepid->setDbValue($conn->Insert_ID());
		$rsnew['p_prepid'] =& $tbl_prep_programs->p_prepid->DbValue;

		// Call Row Inserted event
		$tbl_prep_programs->Row_Inserted($rsnew);
	}
	return $AddRow;
}
?>
