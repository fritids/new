...
if (@$_POST["a_edit"] <> "") {
	$tbl_students->CurrentAction = $_POST["a_edit"]; // Get action code
	LoadFormValues(); // Get form values
} else {
	$tbl_students->CurrentAction = "I"; // Default action is display
}

// Check if valid key
if ($tbl_students->s_studentid->CurrentValue == "") Page_Terminate($tbl_students->getReturnUrl()); // Invalid key, exit
if ($tbl_students->s_usrname->CurrentValue == "") Page_Terminate($tbl_students->getReturnUrl()); // Invalid key, exit
...
// Render the record
$tbl_students->RowType = EW_ROWTYPE_EDIT; // Render as edit
RenderRow();
?>
...
<p><span class="edge">Update  Student Information <br>
...
?>
<form name="ftbl_studentsedit" id="ftbl_studentsedit" action="tbl_studentsedit.php" method="post" onSubmit="return ew_ValidateForm(this);">
<p>
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewTable">
	<input type="hidden" name="x_s_studentid" id="x_s_studentid" value="<?php echo ew_HtmlEncode($tbl_students->s_studentid->CurrentValue) ?>">
	<tr class="ewTableRow">
...
<input type="hidden" name="x_s_usrname" id="x_s_usrname" value="<?php echo ew_HtmlEncode($tbl_students->s_usrname->CurrentValue) ?>">
</span></td>
	</tr>
	<tr class="ewTableRow">
...
<!--
var f = document.ftbl_studentsedit;
