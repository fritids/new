...
// Database connection
define("EW_CONN_HOST", "205.178.146.71", TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", "baracuda", TRUE);
define("EW_CONN_PASS", "henlengA1", TRUE);
define("EW_CONN_DB", "edgetest", TRUE);
...
define("EW_PROJECT_NAME", "schoolteacher", TRUE); // Project Name
define("EW_RANDOM_KEY", 'K0GBxd9e4fY387YV', TRUE); // Random key for encryption
...
define("EW_PARENT_USER_ID_SQL", "SELECT `i_instructorid` FROM `tbl_instructors` WHERE `i_instructorid` = @ParentUserID@", TRUE);
