...
if ($Security->CurrentUserID() <> "" && !$Security->IsAdmin()) { // Non system admin
	...
	if ($tbl_students->getCurrentMasterTable() == "tbl_instructors") {
		$sFilter = $tbl_students->AddDetailUserIDFilter($sFilter, "tbl_instructors", $Security->CurrentUserID()); // Add detail User ID filter
		$sDbMasterFilter = $tbl_students->AddMasterUserIDFilter($sDbMasterFilter, "tbl_instructors", $Security->CurrentUserID()); // Add master User ID filter
	}
}
if ($sDbDetailFilter <> "") {
...
?>
<p><span class="edge" style="white-space: nowrap;"> Students
</span></p>
<?php if ($tbl_students->Export == "") { ?>
...
<?php } else { ?>
	First Name
	<?php if ($tbl_students->s_first_name->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_students->s_first_name->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?>
<?php } ?>		</td>
		<td width="120" valign="top">
<?php if ($tbl_students->Export <> "") { ?>
Last Name
<?php } else { ?>
	Last Name
	<?php if ($tbl_students->s_last_name->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_students->s_last_name->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?>
<?php } ?>		</td>
		<td width="120" valign="top">
<?php if ($tbl_students->Export <> "") { ?>
Middle Name
<?php } else { ?>
	Middle Name
	<?php if ($tbl_students->s_middle_name->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_students->s_middle_name->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?>
<?php } ?>		</td>
...
<?php } else { ?>
	E-mail
	<?php if ($tbl_students->s_student_email->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_students->s_student_email->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?>
<?php } ?>		</td>
		<?php if ($tbl_students->Export == "") { ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php } ?>
...
<div<?php echo $tbl_students->s_middle_name->ViewAttributes() ?>><?php echo $tbl_students->s_middle_name->ViewValue ?></div></td>
		<!-- s_student_email -->
		<td width="200"<?php echo $tbl_students->s_student_email->CellAttributes() ?>>
<div<?php echo $tbl_students->s_student_email->ViewAttributes() ?>><?php echo $tbl_students->s_student_email->ViewValue ?></div></td>
		<!-- s_graduation_year -->
	  <?php if ($tbl_students->Export == "") { ?>
<?php if ($Security->IsLoggedIn()) { ?>
<td nowrap><span class="edge"><?php if (ShowOptionLink()) { ?>
...
function AdvancedSearchWhere() {
	...
	// Field g_grpid
	BuildSearchSql($sWhere, $tbl_students->g_grpid, @$_GET["x_g_grpid"], @$_GET["z_g_grpid"], @$_GET["v_g_grpid"], @$_GET["y_g_grpid"], @$_GET["w_g_grpid"]);
	...
	if ($sWhere <> "") {
		...
		// Field g_grpid
		SetSearchParm($tbl_students->g_grpid, @$_GET["x_g_grpid"], @$_GET["z_g_grpid"], @$_GET["v_g_grpid"], @$_GET["y_g_grpid"], @$_GET["w_g_grpid"]);
	}
	return $sWhere;
}
...
function ResetAdvancedSearchParms() {
	...
	$tbl_students->setAdvancedSearch("x_g_grpid", "");
}
...
function LoadRow() {
	...
	if ($Security->CurrentUserID() <> "" && !$Security->IsAdmin()) { // Non system admin
		$sFilter = $tbl_students->AddUserIDFilter($sFilter, $Security->CurrentUserID()); // Add User ID filter
		$sFilter = $tbl_students->AddDetailUserIDFilter($sFilter, "tbl_instructors", $Security->CurrentUserID()); // Add User ID filter for master table
	}
