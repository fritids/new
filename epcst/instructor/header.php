...
$result = mysql_query("SELECT * FROM tbl_instructors
 WHERE i_uname='$temp'") or die(mysql_error());  
...
<div class="loggedinuser"><?php if (IsLoggedIn()) { ?>Logged in as instructor : <?php echo $row['i_first_name']." ".$row['i_last_name']; ?><?php } ?></div>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
