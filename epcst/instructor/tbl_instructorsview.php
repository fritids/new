...
<p><span class="edge">View TABLE: Instructor
<br><br>
<a href="tbl_instructorslist.php">Back to List</a>&nbsp;
...
<div<?php echo $tbl_instructors->i_mobile->ViewAttributes() ?>><?php echo $tbl_instructors->i_mobile->ViewValue ?></div>
	...
	<tr class="ewTableRow">
		<td class="ewTableHeader">g grpid</td>
		<td<?php echo $tbl_instructors->g_grpid->CellAttributes() ?>>
<div<?php echo $tbl_instructors->g_grpid->ViewAttributes() ?>><?php echo $tbl_instructors->g_grpid->ViewValue ?></div>
</td>
	</tr>
	<tr class="ewTableRow">
...
function RenderRow() {
	...
	// g_grpid
	$tbl_instructors->g_grpid->CellCssStyle = "";
	$tbl_instructors->g_grpid->CellCssClass = "";
	...
	if ($tbl_instructors->RowType == EW_ROWTYPE_VIEW) { // View row
		...
		// g_grpid
		$tbl_instructors->g_grpid->ViewValue = $tbl_instructors->g_grpid->CurrentValue;
		$tbl_instructors->g_grpid->CssStyle = "";
		$tbl_instructors->g_grpid->CssClass = "";
		$tbl_instructors->g_grpid->ViewCustomAttributes = "";
		...
		// g_grpid
		$tbl_instructors->g_grpid->HrefValue = "";
