...
<?php include "ewmenu.php" ?>
			<table border="0" cellspacing="0" cellpadding="0">
				<tr><td width="100%" bgcolor="#f68c1f" class="menutext"><!-- Area below Left Nav --><br/>
				  <br/>
				  <br/><br/>
				    "Not only did two of us get perfect scores (on the hardest SAT II!!),  but we actually had fun with our tutor and looked forward to our  sessions."<br/><br/><br/><br/>
				    <div align="right" style="background-color:#f68c1f" class="parentdiv"><br/> 
...
$result = mysql_query("SELECT * FROM tbl_students
 WHERE s_usrname='$temp'") or die(mysql_error());  
...
?>
		...
		<div class="loggedinuser"><?php if (IsLoggedIn()) { ?>Logged in as student : <?php echo $row['s_first_name']." ".$row['s_last_name']." ".$row['s_middle_name']; ?><?php } ?></div>
