...
<p><span class="edge">Student/Parent Login </span></p>
<?php
...
<table border="0" cellspacing="0" cellpadding="4">
	<tr>
		<td><span class="edge">User Name</span></td>
		<td><span class="edge"><input type="text" name="username" id="username" size="20" value="<?php echo @$_COOKIE[EW_PROJECT_NAME]['UserName'] ?>"></span></td>
	</tr>
	<tr>
		<td><span class="edge">Password</span></td>
		<td><span class="edge"><input type="password" name="password" id="password" size="20"></span></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td><span class="edge">
	...
	<tr>
		<td colspan="2" align="center"><span class="edge"><input type="submit" name="submit" id="submit" value="   Login   "></span></td>
	</tr>
</table>
</form>
<br>
